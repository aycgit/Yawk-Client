...
public enum ChatColor {
	...
	BLACK('0'), DARK_BLUE('1'), DARK_GREEN('2'), DARK_AQUA('3'), DARK_RED('4'), DARK_PURPLE('5'), GOLD('6'), GRAY('7'), DARK_GRAY('8'), BLUE('9'), GREEN('A'), AQUA('B'), RED('C'), PURPLE('D'), YELLOW('E'), WHITE('F'), OBFUSCATED('K'), BOLD('L'), STRIKETHROUGH('M'), UNDERLINE('N'), ITALIC('O'), RESET('R');
	...
	public static final ChatColor[] formats = new ChatColor[]
